...
const Terms = () => {
    return (
        ...
        <main className="text-left mt-[5.4rem]">
          ...
          </header><section className="text-left mt-[3rem] mb-4">
    <div className="flex justify-center p-3">
        <div className="my_fixed_width pb-5">
            <h1 className="text-[1.3rem] font-bold">Introduction:</h1>
            <p className="my-2">
                Welcome to SecretSender! These Terms and Conditions ("Terms") govern your use of the SecretSender mobile and web application (the "App"). By downloading, installing, or using the App, you agree to comply with and be bound by these Terms.
            </p>
            ...
            <p className="my-2">
                The App, including all content, features, and functionality, is owned by or licensed to SecretSender. You agree not to reproduce, distribute, modify, or create derivative works from any part of the App without prior written consent.
            </p>
            <h1 className="text-[1.3rem] font-bold mt-10">Termination:</h1>
            <p className="my-2">
                We may terminate or suspend your access to the App at any time without notice if you violate these Terms or engage in conduct harmful to SecretSender. Upon termination, all rights granted to you under these Terms will cease.
            </p>
            <h1 className="text-[1.3rem] font-bold mt-10">Limitation of Liability:</h1>
            <p className="my-2">
                SecretSender is not liable for any direct, indirect, incidental, or consequential damages arising from your use or inability to use the App. Your sole remedy is to discontinue using the App.
            </p>
