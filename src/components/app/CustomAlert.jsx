    ...
    return (
        ...
        >
            <div className="bg-white rounded-lg font-poppins font-[500] text-black p-8 w-4/5 md:w-1/2 lg:w-1/3 relative">
                <h2 id="myAlertTitle" className="font-semibold text-2xl font-poppins text-center mb-4">
                    {title}
                </h2>
                ...
                <button
                    id="customAlertOk"
                    className="w-full bg-[#DA0037] text-white py-2 rounded-lg font-bold hover:bg-[#990044]"
                    onClick={onClose}
                >
                    Okay
                </button>
